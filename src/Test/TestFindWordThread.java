...
public class TestFindWordThread implements Runnable {
	
	private MachineLearning machineLearning;
	private Log loggingModule;
	private Log logging;
	
	public TestFindWordThread(Log logging) throws IOException{
	...
	public void run(){
		...
		String song="";
		try {
			song = machineLearning.findSound(audio);
		...
		try{
			TimeUnit.SECONDS.sleep(2);
     		...
     		loggingModule.write("An interruption occured","warning",getClass().getName());
     	}
